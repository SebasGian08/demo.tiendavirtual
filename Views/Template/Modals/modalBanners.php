<!-- Modal -->
<div class="modal fade" id="modalFormBanners" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formBanners" name="formBanners" class="form-horizontal">
                ...
                <div class="col-md-6">
                    <div class="photo">
                        ...
                        <div class="prevPhoto">
                          ...
                          <div>
                            <img id="img" src="<?= media(); ?>/images/uploads/portada_Banners.png">
                          </div>
                        </div>
                        <div class="upimg">
...
<!-- Modal -->
<div class="modal fade" id="modalViewBanners" tabindex="-1" role="dialog" aria-hidden="true">
