...
<html lang="en">
  <head>
    <meta name="description" content="Tienda Virtual(Aqui va una descripcion al momento de buscar en google)">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Desarrollador">
    <meta name="theme-color" content="#009688">
    <link rel="shortcut icon" href="<?= media();?> /images/tienda.png">
    <!--Se obtiene desde el controlador -->
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url()?>/dashboard"><img src="<?=media();?>/images/logotulogo.png"  width="150px" alt=""></a>
