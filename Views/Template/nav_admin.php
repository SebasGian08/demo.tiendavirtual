    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?=media();?>/images/usuario_ico.png" width="64px" alt="User Image">
        <div>
          <!-- Nombre de Usuario que jala de BD-->
